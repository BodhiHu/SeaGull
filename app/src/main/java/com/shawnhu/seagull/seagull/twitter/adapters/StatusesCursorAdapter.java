...
final public class StatusesCursorAdapter extends PersistentCursorAdapter {

    static final public String[] PROJECTION = TweetStore.Statuses.COLUMNS;
    static final public String   SELECTION  =
            "(" +
                    "(" + TweetStore.Statuses.ACCOUNT_ID       + "=?)  AND" +
                    "(" + TweetStore.Statuses.STATUS_TIMESTAMP + "<=?) AND" +
                    "(" + TweetStore.Statuses.STATUS_TIMESTAMP + ">=?)" +
            ")";
    static final public String   SORT_ORDER  = TweetStore.Statuses._ID + " DESC";
