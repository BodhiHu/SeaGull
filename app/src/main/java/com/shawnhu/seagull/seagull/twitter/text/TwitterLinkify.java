...
public final class TwitterLinkify {
	...
	private static final String STRING_PATTERN_TWITTER_PROFILE_IMAGES_NO_SCHEME = "(twimg[\\d\\w\\-]+\\.akamaihd\\.net|[\\w\\d]+\\.twimg\\.com)\\/profile_images\\/([\\d\\w\\-_]+)\\/([\\d\\w\\-_]+)_"
			+ TWITTER_PROFILE_IMAGES_AVAILABLE_SIZES + "(\\.?" + MediaPreviewUtils.AVAILABLE_IMAGE_SUFFIX + ")?";
	...
	private final TwitterURLSpan.OnLinkClickListener mOnLinkClickListener;
	private final Extractor mExtractor = new Extractor();
	private int mHighlightOption, mHighlightColor;

	public TwitterLinkify(final TwitterURLSpan.OnLinkClickListener listener) {
		this(listener, TwitterURLSpan.VALUE_LINK_HIGHLIGHT_OPTION_CODE_BOTH, 0);
	}

	public TwitterLinkify(final TwitterURLSpan.OnLinkClickListener listener, final int highlightOption, final int highlightColor) {
	...
	public final void applyAllLinks(final TextView view, final long account_id, final boolean sensitive,
			final TwitterURLSpan.OnLinkClickListener listener, final int highlightOption, final int highlightColor) {
	...
	public final void applyUserProfileLink(final TextView view, final long account_id, final long user_id,
			final String screen_name, final TwitterURLSpan.OnLinkClickListener listener, final int highlightOption,
	...
	public final void applyUserProfileLinkNoHighlight(final TextView view, final long account_id, final long user_id,
		...
		applyUserProfileLink(view, account_id, user_id, screen_name, mOnLinkClickListener,
				TwitterURLSpan.VALUE_LINK_HIGHLIGHT_OPTION_CODE_NONE, mHighlightColor);
	}
	...
	private final void addLinks(final SpannableString string, final long accountId, final int type,
			final boolean sensitive, final TwitterURLSpan.OnLinkClickListener listener, final int highlightOption,
			final int highlightColor) {
		switch (type) {
	...
	private final void applyLink(final String url, final int start, final int end, final Spannable text,
			final long accountId, final int type, final boolean sensitive, final TwitterURLSpan.OnLinkClickListener listener,
