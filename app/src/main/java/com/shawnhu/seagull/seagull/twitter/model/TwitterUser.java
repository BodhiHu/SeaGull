...
public class TwitterUser implements ParcelableWithJSON, Comparable<TwitterUser> {

    public static final Parcelable.Creator<TwitterUser> CREATOR = new Parcelable.Creator<TwitterUser>() {
        @Override
        public TwitterUser createFromParcel(final Parcel in) {
            return new TwitterUser(in);
        }

        @Override
        public TwitterUser[] newArray(final int size) {
            return new TwitterUser[size];
        }
    };

    public static final JSONParcelable.Creator<TwitterUser> JSON_CREATOR = new JSONParcelable.Creator<TwitterUser>() {
        @Override
        public TwitterUser createFromParcel(final JSONParcel in) {
            return new TwitterUser(in);
        }
    ...
    public TwitterUser(final Cursor cursor, final long account_id) {
    ...
    public TwitterUser(final JSONParcel in) {
    ...
    public TwitterUser(final Parcel in) {
    ...
    public TwitterUser(final twitter4j.User user, final long account_id) {
        this(user, account_id, 0);
    }

    public TwitterUser(final twitter4j.User user, final long account_id, final long position) {
    ...
    @Override
    public int compareTo(final TwitterUser that) {
    ...
    public static ContentValues makeCachedUserContentValues(final TwitterUser user) {
