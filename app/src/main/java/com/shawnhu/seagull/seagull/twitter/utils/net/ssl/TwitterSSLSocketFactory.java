...
public final class TwitterSSLSocketFactory implements LayeredConnectionSocketFactory {

    private final Context context;
    private final boolean ignoreSSLErrors;
    private final HostResolvedSSLConnectionSocketFactory delegated;

    private TwitterSSLSocketFactory(final Context context, final boolean ignoreSSLErrors)
        ...
        final X509HostnameVerifier hostnameVerifier = new TwitterHostnameVerifier(context, ignoreSSLErrors);
    ...
    public static LayeredConnectionSocketFactory getSocketFactory(final Context context, final boolean ignoreSSLErrors)
        ...
        try {
            return new TwitterSSLSocketFactory(context, ignoreSSLErrors);
