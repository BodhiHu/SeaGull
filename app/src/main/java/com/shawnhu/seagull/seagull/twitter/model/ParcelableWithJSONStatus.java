...
public class ParcelableWithJSONStatus implements ParcelableWithJSON, Comparable<ParcelableWithJSONStatus> {

	public static final Parcelable.Creator<ParcelableWithJSONStatus> CREATOR = new Parcelable.Creator<ParcelableWithJSONStatus>() {
		@Override
		public ParcelableWithJSONStatus createFromParcel(final Parcel in) {
			return new ParcelableWithJSONStatus(in);
		}

		@Override
		public ParcelableWithJSONStatus[] newArray(final int size) {
			return new ParcelableWithJSONStatus[size];
		}
	};

	public static final JSONParcelable.Creator<ParcelableWithJSONStatus> JSON_CREATOR = new JSONParcelable.Creator<ParcelableWithJSONStatus>() {
		@Override
		public ParcelableWithJSONStatus createFromParcel(final JSONParcel in) {
			return new ParcelableWithJSONStatus(in);
		}
	...
	public static final Comparator<ParcelableWithJSONStatus> TIMESTAMP_COMPARATOR = new Comparator<ParcelableWithJSONStatus>() {

		@Override
		public int compare(final ParcelableWithJSONStatus object1, final ParcelableWithJSONStatus object2) {
	...
	public static final Comparator<ParcelableWithJSONStatus> REVERSE_ID_COMPARATOR = new Comparator<ParcelableWithJSONStatus>() {
	...
	public ParcelableWithJSONStatus(final ContentValues values) {
		...
		location = ParcelableLocation.fromString(values.getAsString(TweetStore.Statuses.LOCATION));
		...
		medias = ParcelableMedia.fromJSONString(values.getAsString(TweetStore.Statuses.MEDIAS));
		...
		mentions = ParcelableUserMention.fromJSONString(values.getAsString(TweetStore.Statuses.MENTIONS));
		first_media = values.getAsString(TweetStore.Statuses.FIRST_MEDIA);
	}

	public ParcelableWithJSONStatus(final Cursor c, final CursorIndices idx) {
	...
	public ParcelableWithJSONStatus(final JSONParcel in) {
	...
	public ParcelableWithJSONStatus(final Parcel in) {
		id = in.readLong();
	...
	public ParcelableWithJSONStatus(final Status orig, final long account_id, final boolean is_gap) {
		this.is_gap = is_gap;
	...
	@Override
	public int compareTo(final ParcelableWithJSONStatus another) {
	...
	public boolean equals(final Object obj) {
		...
		if (!(obj instanceof ParcelableWithJSONStatus)) return false;
		final ParcelableWithJSONStatus other = (ParcelableWithJSONStatus) obj;
